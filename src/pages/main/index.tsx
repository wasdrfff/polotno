        ...
        <div className="main-page__block presentation-block">
          ...
          <div className="presentation-block__image-wrapper">
            <img
              src={square}
              alt="top-square"
              className="main-page__top-square-image"
            />
            <img
              src={square}
              alt="bottom-square"
              className="main-page__bottom-square-image"
            />
      ...
      <div className="main-page__block slider-block">
        ...
        <div className="main-page__slider-wrapper">
          <img
            src={square}
            alt="top-square"
            className="main-page__slider-square-image main-page__slider-square-image_top"
          />
          <img
            src={square}
            alt="bottom-square"
